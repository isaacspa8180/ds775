...
dfFactories <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='A2:A6')
dfWarehouse <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='B2:B11')
dfStores <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='C2:C621')
dfProducts <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='D2:D36')
...
dfTableRoutesFW <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='G3:J71')
dfTableRoutesWS <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='L3:O202')
dfSupply <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='Q3:S15')
dfDemand <- readWorksheetFromFile('transpStoreBigSheet.xlsx',sheet=1,region='V3:X102')
